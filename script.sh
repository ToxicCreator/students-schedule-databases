...
docker run -d --name elastic_c -p 9200:9200 -e "xpack.security.enabled=false" -e "discovery.type=single-node" elasticsearch:8.4.3
docker run -d --name redis_c -p 6379:6379 redis
